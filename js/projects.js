/* ============================================================================
   ...
   case-study.html?project=SLUG    (مثلا case-study.html?project=healthcare)
   ...
   4) اگر عکس اسکرین‌شات داری، آن را در images/projects/ بگذار و آدرسش را در
      فیلد cover بنویس. وگرنه از پیش‌فرض زیر استفاده کن:
      cover: "images/projects/default-cover.svg"
   ============================================================================ */

const PROJECTS = [

  // ── پروژه ۱: داشبوردهای چندنقشه‌ی بهداشت (featured) ────────────────────
  {
    slug: "healthcare",
    featured: true,
    ...
    description: "A unified clinical platform with four distinct role-based dashboards for Admins, Secretaries, Doctors, and Specialists — handling patient management, lab results, appointments, and mental health workflows.",
    ...
    caseStudy: {
      ...
      approach: {
        intro: "Rather than building four separate applications, we designed a single Angular codebase with role-based routing and dynamically loaded modules — each role gets exactly the interface it needs, without any of the overhead of the others.",
        points: [
      ...
      results: {
        stats: [
          ...
          { number: "1",     label: "Unified patient timeline replacing 5 separate tools" },
      ...
      stack: ["Angular 18", "Angular Signals", "PrimeNG", "Role-Based Routing", "Lazy Loading", "REST APIs", "RxJS"]
    }
  },

  // ── پروژه ۲: پلتفرم پژوهشی هوشمند ────────────────────────────────────────
  {
    ...
    description: "An AI-driven academic collaboration platform connecting researchers, professors, and students through intelligent matching — built with Angular Signals and a modular, scalable architecture.",
    ...
    caseStudy: {
      ...
      approach: {
        intro: "The front-end was designed around the idea that the platform should surface relevant connections proactively, not wait for users to search — and that once a connection is made, the collaboration tools should be immediately at hand.",
        points: [
      ...
      results: {
        stats: [
          ...
          { number: "Modular", label: "Feature modules deployable independently" },
      ...
      stack: ["Angular 18", "Angular Signals", "PrimeNG", "AI Matching API", "Lazy Loading", "RxJS", "REST APIs"]
    }
  },

  // ── پروژه ۳: پایش دوربین خودرو و ناوگان ────────────────────────────────────
  {
    ...
    description: "A real-time dashcam monitoring platform with synchronised cabin and road-facing video streams, live GPS tracking via OpenStreetMap, and an intelligent dashboard for multi-camera control and incident review.",
    ...
    caseStudy: {
      ...
      approach: {
        intro: "We built the platform around a single, unified operator view — GPS position, road-facing stream, and cabin-facing stream all synchronised on one screen, with incident flagging directly from the live view.",
        points: [
      ...
      results: {
        stats: [
          { number: "2",     label: "Synchronised streams per vehicle (cabin + road)" },
          { number: "100s",  label: "Concurrent vehicles handled reliably" },
          { number: "Live",  label: "Incident review from live buffer — no manual retrieval" }
        ],
      ...
      stack: ["Angular", "WebSockets", "OpenStreetMap", "Real-Time Video Streams", "RxJS", "Lazy Loading"]
    }
  },

  // ── پروژه ۴: مدیریت ناوگان با GPS ──────────────────────────────────────────
  {
    ...
    description: "A GPS-based fleet tracking platform for nationwide monitoring — live location updates, geofencing alerts, vehicle immobilization, and interactive dashboards for route history, overspeed, fuel, and diagnostics.",
    ...
    caseStudy: {
      ...
      approach: {
        intro: "The platform was built to give fleet managers complete situational awareness without needing to open anything other than a single dashboard — live position, historical routes, alerts, and vehicle controls all in one place.",
        points: [
      ...
      results: {
        stats: [
          { number: "Nationwide", label: "Fleet visibility, previously unavailable" },
          { number: "Real-time",  label: "Immobilization — seconds vs. vendor call delays" },
          { number: "5 mo.",      label: "Full platform delivered with multiple contributors" }
        ],
      ...
      stack: ["Angular 14", "OpenStreetMap", "WebSockets", "GPS Telemetry", "Geofencing", "RxJS", "REST APIs"]
    }
  },

  // ── پروژه ۵: پلتفرم مدیریت جلسات Didarba ────────────────────────────────
  {
    slug: "didarba",
    featured: false,
    ...
    description: "A dynamic Angular platform for real-time meeting management — advanced scheduling, role-based access, live group chat via SignalR, and seamless in-app voice/video calls powered by BigBlueButton.",
    ...
    caseStudy: {
      ...
      approach: {
        intro: "Didarba consolidates the entire meeting lifecycle into one Angular application — from scheduling and invitations through live chat, video, and post-meeting records — with each participant seeing exactly the interface appropriate to their role.",
        points: [
      ...
      results: {
        stats: [
          ...
          { number: "Live", label: "Chat + video in the same window — no redirects" },
      ...
      stack: ["Angular", "SignalR", "BigBlueButton", "RxJS", "Role-Based Routing", "Lazy Loading", "REST APIs"]
    }
  }
